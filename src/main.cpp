...
const string strMessageMagic = "Wexcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Wexcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Bitcoin Price Ends Week as Bull Fades Run April 29, 2016 at 21:15 BST";
        CTransaction txNew;
        txNew.nTime = 1469200410;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x54cfa60336f9786f77a1d2216a3a4a02314efc07e85fadcdf4605f3424238c49"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd3, 0xa1, 0x3e, 0xe5 };
